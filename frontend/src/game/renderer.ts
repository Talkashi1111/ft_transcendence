...
export function drawScore(ctx: CanvasRenderingContext2D, gameState: GameState): void {
  ...
  // Player 1 score (left)
  ctx.fillText(
    gameState.player1.paddle.score.toString(),
    GAME_CONFIG.canvasWidth / 4,
    60
  )

  // Player 2 score (right)
  ctx.fillText(
    gameState.player2.paddle.score.toString(),
    (GAME_CONFIG.canvasWidth * 3) / 4,
    60
  )
}
