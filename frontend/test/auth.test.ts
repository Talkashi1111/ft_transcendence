...
import { login, logout, isAuthenticated, getCurrentUser, getUserId, getAuthHeaders } from '../src/utils/auth'
...
describe('Auth Utility', () => {
  ...
  describe('login', () => {
    ...
    it('should throw error on 400 (validation error)', async () => {
      ...
      await expect(login('invalid', 'pass')).rejects.toThrow('Please check your email and password format')
    })
