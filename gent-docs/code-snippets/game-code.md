...
---
## Tailwind CSS
**Tailwind CSS** is a *utility-first CSS framework* used to build custom user interfaces directly in HTML (or JSX, templates, etc.) without writing traditional CSS files.
...
Object.prototype.superHack = function() { console.log("Je suis partout !"); };
```
